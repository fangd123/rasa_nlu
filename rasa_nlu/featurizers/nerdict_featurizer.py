...
class NerdictFeaturizer(Featurizer):
    name = "intent_entity_featurizer_nerdict"
    ...
    def __init__(self, component_config=None, known_patterns=None):
        super(NerdictFeaturizer, self).__init__(component_config)


        self.known_patterns = known_patterns.split('\n') if known_patterns else []
